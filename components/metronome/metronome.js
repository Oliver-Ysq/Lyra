...
Component({
  ...
  methods: {
    ...
    tapHandle() {
      var noteStr = this.data.note.toString() + "/" + this.data.beat.toString();
      console.log(noteStr);
    ...
    startHandle: function () {
      ...
      wx.setStorage({
        key: 'noteStr',
        data: self.data.note.toString() + "/" + self.data.beat.toString()
      })
    ...
    onLoad: function () {
      ...
      this.setData({
        bpm: parseInt(this.properties.bpm),
        note: parseInt(this.properties.note),
        beat: parseInt(this.properties.beat),
      })
      console.log(this.properties.bpm + " " + this.properties.note + " " + this.properties.beat)
    },
    // 生成beatarr
    setBeatArr: function () {
      var self = this;
